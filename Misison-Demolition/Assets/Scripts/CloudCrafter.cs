...
public class CloudCrafter : MonoBehaviour
{
    ...
    public GameObject cloudPrefab; //The prefab for cloud
    ...
    void Awake()
    {
        ...
        for (int i = 0; i < numClouds; i++)
        {
            ...
            cPos.x = Random.Range(cloudPosMax.x, cloudPosMax.x);
            ...
            //scaller clouds (with smaller scaleU) should be nearer the ground
